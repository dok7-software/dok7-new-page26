...
const CTASection = () => {
  ...
  return (
    <section id="contact" className="py-24 md:py-32 relative overflow-hidden bg-section-dark">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] rounded-full bg-gradient-to-r from-accent/20 via-secondary/15 to-primary/20 blur-[120px]" />
      
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          {/* Card con efectos visuales */}
          <div className="relative">
            {/* Decorative floating circles */}
            <div className="absolute -top-8 -left-8 w-24 h-24 rounded-full bg-gradient-to-br from-accent to-secondary opacity-20 blur-2xl animate-pulse-soft"></div>
            <div className="absolute -bottom-8 -right-8 w-32 h-32 rounded-full bg-gradient-to-br from-secondary to-primary opacity-20 blur-2xl animate-pulse-soft"></div>
            
            <div className="soft-card py-16 px-8 md:py-20 md:px-16 lg:py-24 lg:px-20 relative overflow-hidden">
              {/* Inner gradient decoration */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-accent/10 via-secondary/5 to-transparent rounded-full blur-3xl"></div>
              <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-primary/10 via-secondary/5 to-transparent rounded-full blur-3xl"></div>
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="inline-flex items-center gap-2 text-muted-foreground">
                  <span className="text-sm">o escríbenos a</span>
                  <a 
